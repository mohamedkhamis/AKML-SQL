...
{
    /// <summary>
    /// Adds or removes [brackets] on identifiers in the active SQL document.
    /// </summary>
    internal static class ToggleBracketsCommand
    {
        public static void Initialize(AsyncPackage package, OleMenuCommandService commandService)
        {
            var cmdId = new CommandID(PackageGuids.AkmlSqlCmdSet, CommandIds.CmdToggleBrackets);
        ...
        private static void Execute(object sender, EventArgs e)
        {
            ...
            {
                Log.Error(ex, "Toggle brackets command failed");
            }
        }
    }
}
