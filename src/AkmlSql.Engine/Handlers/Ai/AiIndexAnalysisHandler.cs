...
public sealed class AiIndexAnalysisHandler : AiHandlerBase<AiIndexAnalysisRequest, AiIndexAnalysisResponse>
{
    ...
    public override AiFeature Feature => AiFeature.IndexSuggestions;
    ...
    protected override async Task<AiIndexAnalysisResponse> InvokeAsync(
        AiIndexAnalysisRequest request, RpcContext ctx, AiSettings settings, AiAgent? resolvedAgent, Stopwatch sw, CancellationToken ct)
    {
        ...
        if (usedFallback)
            summary = $"[Note: Response generated by fallback agent ({agentName})]\n{summary}";
