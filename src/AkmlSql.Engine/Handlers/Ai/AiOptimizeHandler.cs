...
public sealed class AiOptimizeHandler : AiHandlerBase<AiOptimizeRequest, AiOptimizeResponse>
{
    ...
    public override AiFeature Feature => AiFeature.Optimize;
    ...
    protected override async Task<AiOptimizeResponse> InvokeAsync(
        AiOptimizeRequest request, RpcContext ctx, AiSettings settings, AiAgent? resolvedAgent, Stopwatch sw, CancellationToken ct)
    {
        ...
        if (usedFallback)
            explanation = $"[Note: Response generated by fallback agent ({agentName})]\n{explanation}";
