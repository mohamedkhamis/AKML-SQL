...
public sealed class AiFixHandler : AiHandlerBase<AiFixRequest, AiFixResponse>
{
    ...
    public override AiFeature Feature => AiFeature.Fix;
    ...
    protected override async Task<AiFixResponse> InvokeAsync(
        AiFixRequest request, RpcContext ctx, AiSettings settings, AiAgent? resolvedAgent, Stopwatch sw, CancellationToken ct)
    {
