...
2. **Check checklists status** (if FEATURE_DIR/checklists/ exists):
   ...
   - `checklists/requirements.md` is the built-in spec-quality checklist maintained by `/skill:speckit-specify` and `/skill:speckit-clarify`; custom checklists generated by `/skill:speckit-checklist` are reviewer-owned requirements-quality review artifacts
