# tests\AkmlSql.Core.Tests\AkmlSql.Core.Tests.csproj
...
- **Lines of Code**: 11082
- **Estimated LOC to modify**: 39+ (at least 0.4% of the project)
...
```mermaid
flowchart TB
    subgraph current["AkmlSql.Core.Tests.csproj"]
        MAIN["<b>📦&nbsp;AkmlSql.Core.Tests.csproj</b><br/><small>net10.0</small>"]
        click MAIN "../projects/AkmlSql.Core.Tests.md"
    end
