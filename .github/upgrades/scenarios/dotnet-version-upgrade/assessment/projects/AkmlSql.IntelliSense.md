# src\AkmlSql.IntelliSense\AkmlSql.IntelliSense.csproj
...
**Depended on by (11)** — projects that reference this one:
...
flowchart TB
    ...
    subgraph current["AkmlSql.IntelliSense.csproj"]
        MAIN["<b>📦&nbsp;AkmlSql.IntelliSense.csproj</b><br/><small>net10.0</small>"]
        click MAIN "../projects/AkmlSql.IntelliSense.md"
    end
