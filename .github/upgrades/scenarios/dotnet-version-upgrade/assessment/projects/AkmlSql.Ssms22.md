...
- **Lines of Code**: 63272
- **Estimated LOC to modify**: 34502+ (at least 54.5% of the project)
...
```mermaid
flowchart TB
    subgraph current["AkmlSql.Ssms22.csproj"]
        MAIN["<b>📦&nbsp;AkmlSql.Ssms22.csproj</b><br/><small>net472</small>"]
        click MAIN "../projects/AkmlSql.Ssms22.md"
    end
