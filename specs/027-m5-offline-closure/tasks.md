...
- [ ] T035 [P] Mark spec 021 **T113** `[X]` in `specs/021-web-edition/tasks.md` — pending (T030 scaffold is Skip-flagged/developer-side, so T113's "runs against a real engine" is not yet evidenced; will mark when the E2E actually runs).
