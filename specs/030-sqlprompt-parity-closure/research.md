...
**T008 BUG-FIXING COMPLETE: DmlRules ✅ · DdlRules ✅ · ControlFlowRules CASE ✅.** Remaining T008: the one-time golden re-bless (all rules on) + flip `RuleEngine.DefaultOrder` on; plus the compact collapse-vs-expand precedence as a follow-up.
